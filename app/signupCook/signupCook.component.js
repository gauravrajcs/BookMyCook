...
var CookSignupComponent = (function () {
    function CookSignupComponent(http, _router) {
        this.http = http;
        this.data = {
            "name": "GAURAV",
    ...
    // name: string = "axs";
    CookSignupComponent.prototype.onSubmit = function () {
    ...
    CookSignupComponent = __decorate([
        core_1.Component({
            templateUrl: '/app/signupCook/signupCook.component.html'
        }),
        __metadata("design:paramtypes", [http_1.Http, router_1.Router])
    ], CookSignupComponent);
    return CookSignupComponent;
}());
exports.CookSignupComponent = CookSignupComponent;
...
//# sourceMappingURL=signupCook.component.js.map